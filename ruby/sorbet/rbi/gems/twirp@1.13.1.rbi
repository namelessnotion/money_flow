...
# permissions and limitations under the License.
#
# pkg:gem/twirp#lib/twirp/version.rb:14
module Twirp; end

# pkg:gem/twirp#lib/twirp/client.rb:23
class Twirp::Client
  ...
  #
  # pkg:gem/twirp#lib/twirp/client.rb:132
  ...
  #
  # pkg:gem/twirp#lib/twirp/client.rb:151
  ...
  class << self
    ...
    #
    # pkg:gem/twirp#lib/twirp/client.rb:40
    ...
    #
    # pkg:gem/twirp#lib/twirp/client.rb:78
    ...
    #
    # pkg:gem/twirp#lib/twirp/client.rb:98
...
#
# pkg:gem/twirp#lib/twirp/client_json.rb:20
class Twirp::ClientJSON < ::Twirp::Client
  # pkg:gem/twirp#lib/twirp/client_json.rb:22
  def initialize(conn, opts = T.unsafe(nil)); end
  ...
  #
  # pkg:gem/twirp#lib/twirp/client_json.rb:34
  def rpc(rpc_method, attrs = T.unsafe(nil), req_opts = T.unsafe(nil)); end

  private

  # pkg:gem/twirp#lib/twirp/client_json.rb:47
  def rpc_response_to_clientresp(resp); end
end

# pkg:gem/twirp#lib/twirp/client_resp.rb:15
class Twirp::ClientResp
  # pkg:gem/twirp#lib/twirp/client_resp.rb:21
  def initialize(data: T.unsafe(nil), body: T.unsafe(nil), error: T.unsafe(nil), headers: T.unsafe(nil)); end

  # pkg:gem/twirp#lib/twirp/client_resp.rb:17
  def body; end

  # pkg:gem/twirp#lib/twirp/client_resp.rb:17
  def body=(_arg0); end

  # pkg:gem/twirp#lib/twirp/client_resp.rb:16
  def data; end

  # pkg:gem/twirp#lib/twirp/client_resp.rb:16
  def data=(_arg0); end

  # pkg:gem/twirp#lib/twirp/client_resp.rb:18
  def error; end

  # pkg:gem/twirp#lib/twirp/client_resp.rb:18
  def error=(_arg0); end

  # pkg:gem/twirp#lib/twirp/client_resp.rb:19
  def headers; end
...
#
# pkg:gem/twirp#lib/twirp/error.rb:41
...
#
# pkg:gem/twirp#lib/twirp/error.rb:18
Twirp::ERROR_CODES_TO_HTTP_STATUS = T.let(T.unsafe(nil), Hash)

# pkg:gem/twirp#lib/twirp/encoding.rb:18
module Twirp::Encoding
  class << self
    # pkg:gem/twirp#lib/twirp/encoding.rb:28
    def decode(bytes, msg_class, content_type); end

    # pkg:gem/twirp#lib/twirp/encoding.rb:49
    def decode_json(bytes); end

    # pkg:gem/twirp#lib/twirp/encoding.rb:37
    def encode(msg_obj, msg_class, content_type); end

    # pkg:gem/twirp#lib/twirp/encoding.rb:45
    def encode_json(attrs); end

    # pkg:gem/twirp#lib/twirp/encoding.rb:53
    def valid_content_type?(content_type); end

    # pkg:gem/twirp#lib/twirp/encoding.rb:57
    def valid_content_types; end
  end
end

# pkg:gem/twirp#lib/twirp/encoding.rb:19
...
#
# pkg:gem/twirp#lib/twirp/encoding.rb:23
Twirp::Encoding::JSON_STRICT = T.let(T.unsafe(nil), String)

# pkg:gem/twirp#lib/twirp/encoding.rb:24
...
#
# pkg:gem/twirp#lib/twirp/error.rb:47
class Twirp::Error
  ...
  #
  # pkg:gem/twirp#lib/twirp/error.rb:78
  def initialize(code, msg, meta = T.unsafe(nil)); end

  # pkg:gem/twirp#lib/twirp/error.rb:72
  def cause; end

  # pkg:gem/twirp#lib/twirp/error.rb:72
  def cause=(_arg0); end

  # pkg:gem/twirp#lib/twirp/error.rb:70
  def code; end

  # pkg:gem/twirp#lib/twirp/error.rb:98
  def inspect; end
  ...
  #
  # pkg:gem/twirp#lib/twirp/error.rb:85
  def to_h; end

  # pkg:gem/twirp#lib/twirp/error.rb:94
  def to_s; end

  private

  # pkg:gem/twirp#lib/twirp/error.rb:105
  def validate_meta(meta); end

  class << self
    # pkg:gem/twirp#lib/twirp/error.rb:58
    ...
    #
    # pkg:gem/twirp#lib/twirp/error.rb:64
    ...
    # pkg:gem/twirp#lib/twirp/error.rb:49
    def valid_code?(code); end
  end
end

# pkg:gem/twirp#lib/twirp/service.rb:21
class Twirp::Service
  extend ::Twirp::ServiceDSL

  # pkg:gem/twirp#lib/twirp/service.rb:42
  def initialize(handler); end

  # Setup hook blocks.
  #
  # pkg:gem/twirp#lib/twirp/service.rb:52
  def before(&block); end

  # Rack app handler.
  #
  # pkg:gem/twirp#lib/twirp/service.rb:62
  ...
  #
  # pkg:gem/twirp#lib/twirp/service.rb:95
  def call_rpc(rpc_method, input = T.unsafe(nil), env = T.unsafe(nil)); end

  # pkg:gem/twirp#lib/twirp/service.rb:55
  def exception_raised(&block); end

  # Service full_name is needed to route http requests to this service.
  #
  # pkg:gem/twirp#lib/twirp/service.rb:58
  def full_name; end

  # pkg:gem/twirp#lib/twirp/service.rb:59
  def name; end

  # pkg:gem/twirp#lib/twirp/service.rb:54
  def on_error(&block); end

  # pkg:gem/twirp#lib/twirp/service.rb:53
  ...
  #
  # pkg:gem/twirp#lib/twirp/service.rb:162
  def call_handler(env); end

  # pkg:gem/twirp#lib/twirp/service.rb:193
  def error_response(twerr, env); end

  # pkg:gem/twirp#lib/twirp/service.rb:202
  def exception_response(e, env); end

  # pkg:gem/twirp#lib/twirp/service.rb:156
  ...
  #
  # pkg:gem/twirp#lib/twirp/service.rb:113
  def route_request(rack_env, env); end

  # pkg:gem/twirp#lib/twirp/service.rb:179
  def success_response(output, env); end

  class << self
    # Rack response with a Twirp::Error
    #
    # pkg:gem/twirp#lib/twirp/service.rb:33
    ...
    #
    # pkg:gem/twirp#lib/twirp/service.rb:30
...
module Twirp::ServiceDSL
  ...
  #
  # pkg:gem/twirp#lib/twirp/service_dsl.rb:69
  def rpcs; end

  # Configure service name.
  #
  # pkg:gem/twirp#lib/twirp/service_dsl.rb:24
  ...
  #
  # pkg:gem/twirp#lib/twirp/service_dsl.rb:63
  def service_full_name; end

  # Service name as String. Defaults to the class name.
  #
  # pkg:gem/twirp#lib/twirp/service_dsl.rb:55
  def service_name; end
end

# pkg:gem/twirp#lib/twirp/version.rb:15
